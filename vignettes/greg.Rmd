...
The technical details (incl. references to the literature) of the robust generalized regression and the robust ratio predictor are documented in file <code>/doc/greg.pdf</code>.
</p>
</div>
