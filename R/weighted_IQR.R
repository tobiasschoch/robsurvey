...
#'
#' By default, the weighted IQR is normalized to be an unbiased estimate of scale at the Gaussian core model. If normalization is not desired, put \code{constant = 1}.
#'
...
#' @param constant \code{[double]} constant scaling factor to make the weighted IQR a consistent estimator of the scale (default: \code{1.3490}).
#' @return Weighted IQR 
#'
#' @examples
#' data(workplace) 
...
#' @export 
weighted_IQR <- function(x, w, na.rm = FALSE, constant = 1.3490)
{
